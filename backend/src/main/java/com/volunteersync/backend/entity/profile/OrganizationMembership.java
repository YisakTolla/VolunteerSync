...
/**
 * Entity representing a volunteer's membership/relationship with an
 * organization.
...
public class OrganizationMembership {
    ...
    private String currentRole = "Volunteer";
    ...
    public void changeRole(String newRole, MembershipType newType, String reason) {
        ...
        // Example: {"date": "2024-01-15", "from": "Volunteer", "to": "Coordinator",
        // "reason": "Promotion"}
    }
